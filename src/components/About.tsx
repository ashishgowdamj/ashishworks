...
const About = () => {
  return (
    <section id="about" className="py-12 lg:py-20 bg-gray-800 px-4">
      <div className="container mx-auto">
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 lg:mb-6">About Me</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="bg-gray-900 p-6 lg:p-8 rounded-2xl">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4 lg:gap-6">
              <div className="bg-gray-900 p-4 lg:p-6 rounded-2xl text-center">
                <div className="text-2xl lg:text-3xl font-bold text-blue-500 mb-2">8+</div>
                <div className="text-gray-300 text-sm lg:text-base">Projects</div>
              </div>
              <div className="bg-gray-900 p-4 lg:p-6 rounded-2xl text-center">
                <div className="text-2xl lg:text-3xl font-bold text-blue-500 mb-2">2+</div>
                <div className="text-gray-300 text-sm lg:text-base">Years Learning</div>
              </div>
              <div className="bg-gray-900 p-4 lg:p-6 rounded-2xl text-center">
                <div className="text-2xl lg:text-3xl font-bold text-blue-500 mb-2">12+</div>
                <div className="text-gray-300 text-sm lg:text-base">Technologies</div>
              </div>
              <div className="bg-gray-900 p-4 lg:p-6 rounded-2xl text-center">
                <div className="text-2xl lg:text-3xl font-bold text-blue-500 mb-2">∞</div>
